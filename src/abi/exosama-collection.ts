...
] & { owner: string; approved: string; tokenId: ethers.BigNumber }

export type ApprovalForAll0Event = [
  owner: string,
  operator: string,
  approved: boolean
] & { owner: string; operator: string; approved: boolean }

export type Lock0Event = [supply: ethers.BigNumber] & {
  supply: ethers.BigNumber
}

export type RoleAdminChanged0Event = [
  role: string,
  previousAdminRole: string,
  newAdminRole: string
] & { role: string; previousAdminRole: string; newAdminRole: string }

export type RoleGranted0Event = [
  role: string,
  account: string,
  sender: string
] & { role: string; account: string; sender: string }

export type RoleRevoked0Event = [
  role: string,
  account: string,
  sender: string
] & { role: string; account: string; sender: string }

export type SecondarySaleFee0Event = [
  feeRecipient: string,
  feeValueBps: ethers.BigNumber
] & { feeRecipient: string; feeValueBps: ethers.BigNumber }

export type Transfer0Event = [
  from: string,
  to: string,
  tokenId: ethers.BigNumber
] & { from: string; to: string; tokenId: ethers.BigNumber }

export type URI0Event = [tokenId: ethers.BigNumber] & {
  tokenId: ethers.BigNumber
}
...
export type Approve0Function = [to: string, tokenId: ethers.BigNumber] & {
  to: string
  tokenId: ethers.BigNumber
}

export type Batch0Function = [calls: string, revertOnFail: boolean] & {
  calls: string
  revertOnFail: boolean
}

export type Burn0Function = [tokenId: ethers.BigNumber] & {
  tokenId: ethers.BigNumber
}

export type GrantRole0Function = [role: string, account: string] & {
  role: string
  account: string
}

export type Initialize0Function = [
  owner: string,
  admin: string,
  minter: string,
  name: string,
...
export type Mint0Function = [to: string, _customTokenURI: string] & {
  to: string
  _customTokenURI: string
}

export type MintDefault0Function = [to: string] & { to: string }

export type RenounceRole0Function = [role: string, account: string] & {
  role: string
  account: string
}

export type RevokeRole0Function = [role: string, account: string] & {
  role: string
  account: string
}

export type SafeTransferFrom0Function = [
  from: string,
  to: string,
  tokenId: ethers.BigNumber
] & { from: string; to: string; tokenId: ethers.BigNumber }

export type SafeTransferFrom1Function = [
  from: string,
  to: string,
  tokenId: ethers.BigNumber,
  data: string
] & { from: string; to: string; tokenId: ethers.BigNumber; data: string }

export type SetApprovalForAll0Function = [
  operator: string,
  approved: boolean
] & { operator: string; approved: boolean }

export type SetContractURI0Function = [contractURI: string] & {
  contractURI: string
}

export type SetCustomCompositeTokenURIBase0Function = [
  _id: ethers.BigNumber,
  _customCompositeTokenURIBase: string
] & { _id: ethers.BigNumber; _customCompositeTokenURIBase: string }

export type SetCustomTokenURI0Function = [
  _id: ethers.BigNumber,
  _customTokenURI: string
] & { _id: ethers.BigNumber; _customTokenURI: string }

export type SetDefaultTokenURI0Function = [_defaultTokenURI: string] & {
  _defaultTokenURI: string
}

export type SetERC2665Handler0Function = [_erc2665Handler: string] & {
  _erc2665Handler: string
}

export type SetFee0Function = [
  _feeRecipient: string,
  _feeValueBps: ethers.BigNumber
] & { _feeRecipient: string; _feeValueBps: ethers.BigNumber }

export type SetGlobalCompositeTokenURIBase0Function = [
  _globalCompositeTokenURIBase: string
] & { _globalCompositeTokenURIBase: string }

export type SetProxyRegistryAddress0Function = [
  _proxyRegistryAddress: string
] & { _proxyRegistryAddress: string }

export type SetTransferListener0Function = [_transferListener: string] & {
  _transferListener: string
}

export type SetUseCompositeTokenURI0Function = [
  _id: ethers.BigNumber,
  _useComposite: boolean
] & { _id: ethers.BigNumber; _useComposite: boolean }
...
export class Contract {
  ...
  async royaltyInfo(
    arg0: ethers.BigNumber,
    _salePrice: ethers.BigNumber
  ): Promise<
    [receiver: string, royaltyAmount: ethers.BigNumber] & {
      receiver: string
